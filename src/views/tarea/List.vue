    ...
    <CCard>
      <CCardHeader>
        ...
        <div class="card-header-actions">
          <CButton v-if="esJefe" @click="modalTarea" block color="primary"
            >Nueva Tarea</CButton
          >
        </div>
      </CCardHeader>
      ...
      <CCardBody>
        <CTabs variant="pills" :active-tab="0">
          <CTab title="Nuevo">
            ...
            <div v-else>
              <center>
                <img src="img/imagemepty.png" width="300" alt="" />
                <h5>Sin Tareas</h5>
              </center>
            </div>
          </CTab>
          ...
          <CTab title="Proceso">
            ...
            <div v-if="items.itemsProces > 0">
              <CRow>
                <CCol
                  sm="6"
                  md="4"
                  v-for="item in itemsProces"
                  :key="item.id_tarea"
                >
                  <b-card no-body class="overflow-hidden" footer-tag="footer">
                    <b-row no-gutters>
          ...
          <CTab title="Terminado">
            ...
            <div v-if="items.itemsFinish > 0">
              <CRow>
              <CCol
                sm="6"
                md="4"
                v-for="item in itemsFinish"
                :key="item.id_tarea"
              >
                <b-card no-body class="overflow-hidden" footer-tag="footer">
                  <b-row no-gutters>
