    ...
    <CCard>
      <CCardHeader>
        ...
        <div class="card-header-actions"> 
          <CButton v-if="esJefe" @click="nuevoProyecto" block color="primary">Nuevo Proyecto</CButton>
        </div>
      </CCardHeader>
    </CCard>
          ...
          <b-card  border-variant="primary" >
            <b-dropdown no-caret  variant="#FFFFF" style="float:right;font-weight: 400" right >      
                 <template slot="button-content">
                    ...
                    <b-dropdown-item  v-if="esJefe" @click="NuevoMiembro(item.id_proyecto)">Nuevo Miembro</b-dropdown-item>
